 ...
 * @author MSI
 */
public class DonateItems extends javax.swing.JFrame {

    /**
     * Creates new form DonateItems
     */
    public DonateItems() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Drop off/Pickup location");
        ...
        jLabel5.setText("Donate Now");

        jButton1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jButton1.setText("Make Your Donation");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonateItems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DonateItems().setVisible(true);
            }
        });
    }
